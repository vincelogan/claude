...
import { EVENTS, NEIGHBORHOODS, ATTRACTIONS } from '@/content';
...
function paths(): string[] {
  const base = ['', 'onde-ficar', 'o-que-fazer', 'onde-comer', 'vip', 'planejar', 'sobre'];
  ...
  return [...base, ...events, ...bairros, ...attractions];
}
