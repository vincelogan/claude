...
export const ATTRACTIONS: Attraction[] = [
  ...
  {
    slug: 'carioca-da-gema',
    name: 'Carioca da Gema',
    category: 'vida-noturna',
    area: 'Lapa',
    tagline: { pt: 'Samba e choro de primeira na Lapa', en: 'First-class samba and choro in Lapa' },
    metaDescription: {
      pt: 'Carioca da Gema: uma casa de samba e choro intimista e querida na Lapa, com alguns dos melhores músicos da cidade e boa comida. Chegue cedo.',
      en: 'Carioca da Gema: an intimate, beloved samba and choro house in Lapa, with some of the city’s best musicians and good food. Arrive early.',
    },
    intro: [
      {
        pt: 'Uma casa de samba e choro intimista e querida, com alguns dos melhores músicos da cidade e boa comida brasileira. Enche rápido — vá cedo.',
        en: 'An intimate, beloved samba and choro house with some of the city’s best musicians and good Brazilian food. It fills up fast — go early.',
      },
    ],
    howToGet: { pt: 'Uber até a Lapa; volte de aplicativo. Há cover.', en: 'Uber to Lapa; head back by app. There’s a cover charge.' },
    bestTime: { pt: 'Quinta a sábado, quando a Lapa esquenta.', en: 'Thursday to Saturday, when Lapa heats up.' },
    costNote: { pt: 'Cover + consumo; faixa intermediária.', en: 'Cover + spend; mid-range.' },
    tip: { pt: 'Reserve mesa nos fins de semana; o segundo andar tem boa visão do palco.', en: 'Book a table on weekends; the upper floor has a good view of the stage.' },
    hero: '/img/nightlife.svg',
    keywords: ['carioca da gema', 'samba lapa', 'live music rio'],
  },
  {
    slug: 'bip-bip',
    name: 'Bip Bip',
    category: 'vida-noturna',
    area: 'Copacabana',
    tagline: { pt: 'A roda de samba secreta de Copacabana', en: 'Copacabana’s secret samba circle' },
    metaDescription: {
      pt: 'Bip Bip: um bar minúsculo e lendário de Copacabana onde músicos se reúnem para rodas informais de samba, choro e bossa nova. Pegue a cerveja na geladeira.',
      en: 'Bip Bip: a tiny, legendary Copacabana bar where musicians gather for informal samba, choro and bossa nova. Grab your beer from the fridge.',
    },
    intro: [
      {
        pt: 'Um bar minúsculo e lendário onde músicos se reúnem para rodas informais de samba, choro e bossa nova que transbordam para a calçada. Sem palco, quase sem menu.',
        en: 'A tiny, legendary bar where musicians gather for informal samba, choro and bossa nova sessions spilling onto the pavement. No stage, barely a menu.',
      },
    ],
    howToGet: { pt: 'A poucas quadras da orla de Copacabana; vá a pé de dia ou de Uber à noite.', en: 'A few blocks from the Copacabana seafront; walk by day or Uber at night.' },
    bestTime: { pt: 'Noites de roda — chegue cedo, é pequeno.', en: 'Roda nights — arrive early, it’s small.' },
    costNote: { pt: 'Barato; você se serve da geladeira e acerta na saída, na confiança.', en: 'Cheap; you serve yourself from the fridge and tally up honestly.' },
    tip: { pt: 'Respeite o silêncio durante a música e leve dinheiro trocado.', en: 'Keep the noise down during the music and bring small cash.' },
    hero: '/img/nightlife.svg',
    keywords: ['bip bip copacabana', 'samba rio', 'bossa nova bar'],
  },
  {
    slug: 'palaphita-kitch',
    name: 'Palaphita Kitch',
    category: 'vida-noturna',
    area: 'Lagoa',
    tagline: { pt: 'Drinks amazônicos à beira da Lagoa', en: 'Amazonian cocktails by the lagoon' },
    metaDescription: {
      pt: 'Palaphita Kitch: um bar a céu aberto e rústico-chique na beira da Lagoa, de madeira e tochas, com drinks de frutas amazônicas. Lindo ao entardecer.',
      en: 'Palaphita Kitch: an open-air, rustic-chic bar on the edge of the lagoon, of raw timber and torches, with Amazonian-fruit cocktails. Lovely at dusk.',
    },
    intro: [
      {
        pt: 'Um bar a céu aberto e rústico-chique na beira da Lagoa, feito de madeira bruta e iluminado por tochas, com coquetéis de frutas amazônicas. O cenário à beira-d’água é o trunfo.',
        en: 'An open-air, rustic-chic bar on the edge of the lagoon, built from raw timber and lit by torches, with Amazonian-fruit cocktails. The lakeside setting is the appeal.',
      },
    ],
    howToGet: { pt: 'Uber até a Lagoa, lado do Parque dos Patins.', en: 'Uber to the lagoon, near Parque dos Patins.' },
    bestTime: { pt: 'Fim de tarde para o pôr do sol com o Corcovado atrás.', en: 'Late afternoon for sunset with Corcovado behind.' },
    costNote: { pt: 'Intermediário; informal e ao ar livre.', en: 'Mid-range; informal and outdoors.' },
    tip: { pt: 'Leve repelente — é à beira-d’água e abre à noite.', en: 'Bring mosquito repellent — it’s waterside and opens into the night.' },
    hero: '/img/nightlife.svg',
    keywords: ['palaphita kitch', 'lagoa bar rio', 'sunset bar rio'],
  },
  {
    slug: 'bar-do-mineiro',
    name: 'Bar do Mineiro',
    category: 'vida-noturna',
    area: 'Santa Teresa',
    tagline: { pt: 'Boteco mineiro lendário em Santa Teresa', en: 'A legendary Minas boteco in Santa Teresa' },
    metaDescription: {
      pt: 'Bar do Mineiro: um boteco famoso e quase sempre cheio em Santa Teresa, com comida mineira, feijão tropeiro, feijoada aos sábados e cachaça. Paredes de fotos.',
      en: 'Bar do Mineiro: a famous, almost-always-packed boteco in Santa Teresa, with Minas cuisine, feijão tropeiro, Saturday feijoada and cachaça. Walls of photos.',
    },
    intro: [
      {
        pt: 'Um boteco famoso e quase sempre lotado, com cozinha de Minas — feijão tropeiro, feijoada aos sábados — cachaça e paredes cobertas de fotos. Pura Santa Teresa.',
        en: 'A famous, almost-always-packed boteco serving Minas Gerais cuisine — feijão tropeiro, Saturday feijoada — cachaça and walls of photos. Pure Santa Teresa.',
      },
    ],
    howToGet: { pt: 'Bonde ou Uber até Santa Teresa, perto do Largo dos Guimarães.', en: 'Tram or Uber to Santa Teresa, near Largo dos Guimarães.' },
    bestTime: { pt: 'Almoço de sábado para a feijoada; chegue cedo.', en: 'Saturday lunch for the feijoada; arrive early.' },
    costNote: { pt: 'Barato a intermediário.', en: 'Budget to mid-range.' },
    tip: { pt: 'Combine com a Escadaria Selarón na descida para a Lapa.', en: 'Combine it with the Selarón Steps on the way down to Lapa.' },
    hero: '/img/eat.svg',
    keywords: ['bar do mineiro', 'santa teresa boteco', 'feijoada rio'],
  },
  {
    slug: 'museu-de-arte-do-rio',
    officialUrl: 'https://www.museudeartedorio.org.br/',
    name: 'Museu de Arte do Rio (MAR)',
    category: 'cultura',
    area: 'Praça Mauá / Centro',
    tagline: { pt: 'A arte e a história visual do Rio', en: 'Rio’s art and visual history' },
    metaDescription: {
      pt: 'Museu de Arte do Rio (MAR): dois prédios unidos por um teto em forma de onda, na Praça Mauá, dedicados à arte e à história visual da cidade. Vista do terraço.',
      en: 'Museu de Arte do Rio (MAR): two buildings joined by a wave-like roof on Praça Mauá, devoted to the city’s art and visual history. Rooftop views.',
    },
    intro: [
      {
        pt: 'Dois prédios — um palacete restaurado e um antigo terminal — unidos por um teto ondulado, dedicados à arte e à história visual do Rio. O terraço emoldura a Praça Mauá.',
        en: 'Two linked buildings — a restored palace and a former terminal — joined by a wave-like roof, devoted to Rio’s art and visual history. The rooftop frames Praça Mauá.',
      },
    ],
    howToGet: { pt: 'VLT até a Praça Mauá; ao lado do Museu do Amanhã.', en: 'VLT to Praça Mauá; next to the Museum of Tomorrow.' },
    bestTime: { pt: 'Dia de semana; confira o dia de entrada gratuita.', en: 'A weekday; check the free-admission day.' },
    costNote: { pt: 'Ingresso acessível; costuma ter um dia gratuito por semana.', en: 'Affordable ticket; often a free day each week.' },
    tip: { pt: 'Faça o circuito do porto com Museu do Amanhã e AquaRio.', en: 'Do the port circuit with the Museum of Tomorrow and AquaRio.' },
    hero: '/img/sightseeing.svg',
    keywords: ['museu de arte do rio', 'MAR rio', 'praça mauá museum'],
  },
  {
    slug: 'museu-de-arte-moderna',
    name: 'Museu de Arte Moderna (MAM)',
    category: 'cultura',
    area: 'Flamengo / Centro',
    tagline: { pt: 'Modernismo nos jardins de Burle Marx', en: 'Modernism in Burle Marx gardens' },
    metaDescription: {
      pt: 'Museu de Arte Moderna (MAM): um marco modernista no Aterro do Flamengo, com forte acervo e um respeitado cinema de arte. Galerias amplas e fáceis de percorrer.',
      en: 'Museu de Arte Moderna (MAM): a modernist landmark in Flamengo Park, with a strong collection and a respected art-house cinema. Open, easy-to-navigate galleries.',
    },
    intro: [
      {
        pt: 'Um marco da arquitetura modernista brasileira nos jardins de Burle Marx do Aterro do Flamengo, com forte acervo e um respeitado cinema de arte.',
        en: 'A landmark of Brazilian modernist architecture in Flamengo Park’s Burle Marx gardens, with a strong collection and a respected art-house cinema.',
      },
    ],
    howToGet: { pt: 'Metrô até a Glória/Cinelândia + caminhada pelo Aterro, ou Uber.', en: 'Metro to Glória/Cinelândia + a walk through the park, or Uber.' },
    bestTime: { pt: 'Combine com um passeio plano pelo Aterro do Flamengo.', en: 'Combine it with a flat stroll through Flamengo Park.' },
    costNote: { pt: 'Ingresso acessível.', en: 'Affordable ticket.' },
    tip: { pt: 'Confira a programação do cinema do MAM, referência na cidade.', en: 'Check the MAM cinema programme, a city reference.' },
    hero: '/img/things-to-do.svg',
    keywords: ['MAM rio', 'museu de arte moderna rio', 'modern art rio'],
  },
  {
    ...
    category: 'cultura',
    area: 'Gávea',
    tagline: { pt: 'Fotografia num jardim modernista', en: 'Photography in a modernist garden' },
    metaDescription: {
      pt: 'Instituto Moreira Salles: uma casa modernista na Gávea com jardins de Burle Marx, famosa por exposições de fotografia e um café tranquilo. Entrada gratuita.',
      en: 'Instituto Moreira Salles: a modernist house in Gávea with Burle Marx gardens, known for photography exhibitions and a quiet café. Free entry.',
    },
    intro: [
      {
        pt: 'Uma casa modernista na Gávea com jardins de Burle Marx, conhecida por exposições de fotografia e um forte acervo de imagens brasileiras. O café e o jardim são um refúgio.',
        en: 'A modernist house in Gávea with Burle Marx gardens, known for photography exhibitions and a strong archive of Brazilian images. The café and gardens are a refuge.',
      },
    ],
    howToGet: { pt: 'Uber até a Gávea; perto da Lagoa e do Jardim Botânico.', en: 'Uber to Gávea; near the lagoon and Botanical Garden.' },
    bestTime: { pt: 'Dia de semana; veja a programação, que muda com frequência.', en: 'A weekday; check the programme, which rotates often.' },
    costNote: { pt: 'Geralmente gratuito.', en: 'Generally free.' },
    tip: { pt: 'Pare no café com vista do jardim depois da exposição.', en: 'Stop at the garden-view café after the exhibition.' },
    hero: '/img/sightseeing.svg',
    keywords: ['instituto moreira salles', 'IMS rio', 'photography museum rio'],
  },
];
